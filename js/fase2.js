const trashTypes = [
  {
    type: "metal",
    img: "../lixos/metal/metal1.png",
    sound: new Audio("../metal.mp3"),
  },
  {
    type: "plastic",
    img: "../lixos/plastico/plastico1.png",
    sound: new Audio("../plastic.mp3"),
  },
  {
    type: "paper",
    img: "../lixos/papel/papel1.png",
    sound: new Audio("../paper.mp3"),
  },
  {
    type: "glass",
    img: "../lixos/vidro/vidro1.png",
    sound: new Audio("../glassFLAC.mp3"),
  },
  {
    type: "organic",
    img: "../lixos/organico/organico1.png",
    sound: new Audio("../organic.mp3"),
  },
];
...
function touchMove(e) {
  ...
  if (newLeft + trashRect.width > windowWidth)
    newLeft = windowWidth - trashRect.width; // Limite direito
  if (newTop + trashRect.height > windowHeight)
    newTop = windowHeight - trashRect.height; // Limite inferior
  ...
  bins.forEach((bin) => {
    ...
    if (
      ...
      if (bin.dataset.type === draggedTrash.dataset.type) {
        score += 10;
        const sound = trashTypes.find(
          (type) => type.type === draggedTrash.dataset.type
        ).sound;
        sound.currentTime = 0;
        sound.play();
...
document
  .getElementById("goToPhaseScreen")
